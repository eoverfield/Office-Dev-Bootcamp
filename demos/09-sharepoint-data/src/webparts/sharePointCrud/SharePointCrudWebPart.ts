...
import styles from './SharePointCrudWebPart.module.scss';
...
export default class SharePointCrudWebPartWebPart extends BaseClientSideWebPart<ISharePointCrudWebPartProps> {
  //add
  ...
  public render(): void {
    ...
    this.domElement.innerHTML = `
      <div class="${styles.sharePointCrud}">
