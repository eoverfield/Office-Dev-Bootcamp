...
import styles from './StatusIndicatorsWebPart.module.scss';
import * as strings from 'StatusIndicatorsWebPartStrings';

export interface IStatusIndicatorsWebPartProps {
  description: string;
}
...
export default class StatusIndicatorsWebPartWebPart extends BaseClientSideWebPart<IStatusIndicatorsWebPartProps> {
